        ...
        <div>
            ...
            <SliderWrapper>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderSubtitle>Боевик, Фантастика, Приключения, 16+</SliderSubtitle>
                        <SliderTitle>Черная вдова</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                    <SliderNext />
                </SliderItem>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderSubtitle>КОМЕДИЯ, МУЛЬТФИЛЬМ, ПРИКЛЮЧЕНИЯ 16+</SliderSubtitle>
                        <SliderTitle>Рок-Дог 2</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                </SliderItem>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderSubtitle>Музыка, Драма 18+</SliderSubtitle>
                        <SliderTitle>Звук металла</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                </SliderItem>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderTitle>Оставайтесь детьми с семейным билетом от Silver Screen</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                </SliderItem>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderSubtitle>Для настоящих киноманов</SliderSubtitle>
                        <SliderTitle>Единый билет VOKA+ Silver Screen</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                </SliderItem>
                ...
                <SliderItem>
                    ...
                    />
                    <SliderDescription>
                        <SliderSubtitle>Приключения, 16+</SliderSubtitle>
                        <SliderTitle>Блогеры и дороги</SliderTitle>
                        <SliderButton>Купить билет</SliderButton>
                    </SliderDescription>
                </SliderItem>
            </SliderWrapper>
            ...
            <FilmSection>
                    ...
                    <FilmSectionHeader>
                        ...
                        <FilmSectionHeaderTop>
                            <FilmSectionTitle>Кинотеатры Silver Screen</FilmSectionTitle>
                        </FilmSectionHeaderTop>
                        {/* header bottom */}
                        <FilmSectionHeaderBottom>
                            <div>
                                <FilmSectionTab>Сейчас в кино</FilmSectionTab>
                                <FilmSectionTab>Скоро</FilmSectionTab>
                            </div>
                            <FilmSectionShedule>
                                <Link href="/">
            ...
            <PromoSectionWrapper>
                ...
                <PromoSection>
                    ...
                    <PromoColumn style={{width: '500px'}}>
                        <PromoSubtitle>Акция</PromoSubtitle>
                        <PromoTitle>Мир привилегий VISA</PromoTitle>
                        <PromoText>
                            При оплате билетов в кинотеатры Silver Screen cinemas платежными карточками Visa вы получаете скидку!
                        </PromoText>
                        <PromoButton>Подробнее</PromoButton>
                    </PromoColumn>
                </PromoSection>
            </PromoSectionWrapper>
